...
export default function ProductsPage() {
  ...
  const handleDownloadTemplate = async () => {
    try {
      const response = await fetch(ENDPOINTS.accountsPayable.template, {
        headers: {
      ...
      a.href = url;
      a.download = "template_contas_a_pagar.xlsx";
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Cadastre contas a pagar manualmente ou via planilha
          </p>
        </div>
      </div>
